;;; doom-isohedron-theme.el --- inspired by Isohedron Syntax -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-isohedron-theme nil
  "Options for the `doom-isohedron' theme."
  :group 'doom-themes)

(defcustom doom-isohedron-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-isohedron-theme
  :type 'boolean)

(defcustom doom-isohedron-no-highlight-variables nil
...
(def-doom-theme doom-isohedron
  ...
  (
   ...
   (fw-yellow-text     '("#706648" "" "brightblack"))
   (fw-yellow-text-sec '("#ad9b67" "" "brightblack"))
   (fw-yellow          '("#fcdd61" "" "yellow"))
   (fw-yellow-blend    '("#f7e7c2" "" "brightblack"))
   ...
   ;; custom categories
   (-modeline-bright doom-isohedron-brighter-modeline)
   (-no-highlight-variables doom-isohedron-no-highlight-variables)
   (-modeline-pad
  ...
  ((font-lock-builtin-face :inherit 'italic :foreground fg :extend t)
   ...
   ;;;; git-gutter
   (git-gutter:modified :inherit 'fringe :foreground fw-blue)
   (git-gutter:added    :inherit 'fringe :foreground fw-green)
   (git-gutter:deleted  :inherit 'fringe :foreground fw-red)
...
;;; doom-isohedron-theme.el ends here
