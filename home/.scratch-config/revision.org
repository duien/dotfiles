...
(use-package ef-themes
  ...
  (cadr (assoc name (symbol-value (ef-themes--current-theme-palette))))
  ))
...
#+end_src
** Don't silently kill buffers that don't have a file yet
#+begin_src elisp
...
(defun eh/org-update-theme ()
  ...
  (pcase (car custom-enabled-themes)
    ...
    ((or 'ef-light 'ef-day 'ef-summer 'ef-spring)
     ...
     (set-face-attribute 'org-level-8 nil :height 'unspecified)

     ;; set up todo keywords in ef themes (extract colors in general way?)
     (set-face-attribute 'eh/org-keyword-todo nil
