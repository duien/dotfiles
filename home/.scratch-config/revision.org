...
* Things that don't work right [0/7]
:PROPERTIES:
:visibility: folded
:END:
** TODO Something is getting the todo keyword colors stuck in weird states
...
** TODO Configure the more secondary consult functions
