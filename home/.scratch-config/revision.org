...
(use-package mini-frame
  ...
  (setq mini-frame-show-parameters
        '((child-frame-border-width . 8) ;; or maybe 12 matching background
...
* Things that don't work right [4/12]
:PROPERTIES:
:visibility: folded
:END:
...
** TODO Set a better initial window size
** DONE Isohedron restyle selected line in mini-frame
CLOSED: [2022-04-17 Sun 13:03]
:LOGBOOK:
- State "DONE"       from "TODO"       [2022-04-17 Sun 13:03]
:END:
* Footnotes
