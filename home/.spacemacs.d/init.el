...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Rec Mono Custom"
                               :size 16.0
                               :weight normal
                               :width normal)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;;                     :background (modus-themes-color 'green-intense-bg))
  ...
  (setq org-todo-keyword-faces
        '(("TODO" . (
                     ...
                     :background (modus-themes-color 'green-intense-bg)))
          ("QUESTION" . (
                         :foreground (modus-themes-color 'blue-refine-fg)
                         :background (modus-themes-color 'blue-intense-bg)))
          ))
  )
