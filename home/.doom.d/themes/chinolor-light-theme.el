;;; chinolor-light-theme.el --- inspired by Atom One Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup chinolor-light-theme nil
  "Options for the `chinolor-light' theme."
  :group 'doom-themes)

(defcustom chinolor-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'chinolor-light-theme
  :type 'boolean)

(defcustom chinolor-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'chinolor-light-theme
  :type 'boolean)

(defcustom chinolor-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme chinolor-light
  ...
  ((bg         '("#FDF6E3" "#FDF6E3" "white"        ))
   ...
   ;; custom categories
   (-modeline-bright chinolor-light-brighter-modeline)
   (-modeline-pad
    (when chinolor-light-padded-modeline
      (if (integerp chinolor-light-padded-modeline) chinolor-light-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if chinolor-light-brighter-comments
...
;;; chinolor-light-theme.el ends here
